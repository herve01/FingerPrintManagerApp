...
namespace FingerPrintManagerApp.Model.Employe
{
    public class Fonction : ModelBase, IEditableObject, IDataErrorInfo, ICloneable
    {
        ...
        //{
        //    return Niveau == UniteType.Direction ? ((DirectionInterne)Unite).Denomination :
        //                Niveau == UniteType.Division ? ((Division)Unite).Denomination : ((Bureau)Unite).Denomination;
        //}
        ...
        public static string EstimateName(object unite, Grade grade, int numero = 1)
        {
            ...
            //{
            //    var direction = (DirectionInterne)unite;
            ...
            //{
            //    var division = (Division)unite;

            //    if (division.Direction == null)
            //        return string.Format("Chef d'{0}", division.Entite.ToString());
            //    else
            //    {
            //        if (division.Denomination.ToLower().NoAccent().Contains("secretariat"))
            //            return division.Denomination.Replace("Secrétariat", "Secrétaire").Replace("Secretariat", "Secrétaire").Replace("secrétariat", "Secrétaire").Replace("secretariat", "Secrétaire");

            //        return string.Format("Chef de division {0}", division.Denomination);
            //    }
                
            //}
            //else if (unite is Bureau)
            //{
            //    var bureau = (Bureau)unite;
