...
{
    /// <summary>
    /// Logique d'interaction pour PresenceCtrlView.xaml
    /// </summary>
    public partial class PresenceCtrlView : UserControl
    {
        // Animation variables
        Storyboard expandMO;
        Storyboard unexpandMO;

        public PresenceCtrlView()
        {
            InitializeComponent();
        ...
        {
            new PresenceWindowView().ShowDialog();
        }
    }
}
